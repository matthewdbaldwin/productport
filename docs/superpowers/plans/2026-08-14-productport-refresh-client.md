...
5. Rollback: `PRODUCTPORT_REFRESH_ENABLED=false` → peek off + exchange stops requesting pairs; existing pair sessions die at access-token exp and re-SSO. Env-only, no redeploy.
