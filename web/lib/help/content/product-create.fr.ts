  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: 'list', items: [
          'Name, Slug (url key), Subsidiary et Therapeutic area sont obligatoires. Subsidiary est du texte libre ; Therapeutic area est une liste déroulante des huit domaines thérapeutiques canoniques.',
